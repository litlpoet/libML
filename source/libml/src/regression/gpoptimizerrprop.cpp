...
GPOptimizerRprop::~GPOptimizerRprop() = default;

void
GPOptimizerRprop::init(Scalar const& delta0,
                       Scalar const& delta_min,
                       Scalar const& delta_max,
                       Scalar const& eta_minus,
                       Scalar const& eta_plus,
                       Scalar const& eps_stop)
{
  _p->_delta0    = delta0;
...
void
GPOptimizerRprop::maximize(GPRegression* gp, int const& n, bool const& verbose)
{
